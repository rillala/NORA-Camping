<!--用法: <ComponentName :activeDiv="2" activeClass="highlight" /> -->
...
<template>
 <div class="banner bg-blue-1">
    ...
    <div class="bar">
        ...
        <Router-link :to="step.path" class="each-step">
            <div class="box" :class="{ 'currentStep': isActive(index + 1) }"><span>STEP</span>{{ index + 1 }}</div>
