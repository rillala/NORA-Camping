<template>
  ...
  <section class="info-box">
    ...
    <div v-else >
      ...
      <div class="inner">
        <p class="info-title">會員姓名:</p>  <input v-model="memberInfo.name" placeholder="姓名" class="info"/>
      </div>
      <div class="inner">
        <p>會員信箱:</p>  <input v-model="memberInfo.email" placeholder="email" class="info">
      </div>
      <div class="inner">
        <p>會員電話:</p>  <input v-model="memberInfo.phone" placeholder="電話" class="info"/>
      </div>
      <div class="inner">
        <p>會員地址:</p>  <input v-model="memberInfo.address" placeholder="地址" class="info"/>
      </div>

      <div class="box">
        <button class="saveChanges" @click="saveChanges">儲存</button>
