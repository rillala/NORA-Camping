  ...
  <div class="guide-wrap">
    ...
    <div class="guide-card">
      ...
      <div class="area-card">
        ...
        <p class="area-dtl">舒適寬敞的大空間，<br>讓毛孩能自在跑跑跳跳！<br>跟主人一起創造美好又快樂的回憶！<br>
        </p>
        <p class="area-dtl">本區配有安全圍欄，<br>確保寵物在視線範圍內自由玩耍，<br>同時區內設有專門的寵物廢物處理站，以保持環境衛生。
        </p>
      ...
      <div class="area-card">
        ...
        <p class="area-dtl">安靜又舒適的環境，<br>讓貓咪和貓奴們可以享受寧靜的露營體驗。
        </p>
        <p class="area-dtl">專為喜歡安靜休息的露營者及其貓咪同伴而設。<br>
    ...
    <div class="guide-shelter">
      ...
      <p class="shelter-dtl">小小安置流浪貓狗的臨時住所，<br>
        若喜歡貓貓狗狗的你，<br>
        這裡的小動物都在等待他們的家，<br>
        歡迎在旅途中來看看牠們！<br>
        給彼此一個互相認識的機會！
    ...
    <div class="guide-office">
      ...
      <div class="guide-rules-bg">
        ...
        <div class="rules-cloud">
          ...
          <img src="" alt="營區規範裝飾小雲朵">
        </div>
        <div class="guide-rules">
          <img src="" alt="營區規範icon">
          <ol class="guide-rules-list">
            <li>垃圾分類： 請確實做好垃圾分類並放置於指定區域，保持營區清潔。</li>
            <li>夜間安靜： 夜間10點後請保持安靜，尊重其他露營者的休息。</li>
            <li>節約用水： 使用水源時請節約用水，保持營區水資源充足。</li>
            <li>禁火區域： 嚴禁在非指定區域焚火，以確保安全。</li>
            <li>寵物： 若攜帶寵物，請確認寵物是否需要牽繩，並留意寵物糞便的清理。</li>
            <li>禁止破壞植被： 請勿破壞營區植物，保護自然環境。</li>
            <li>共用設施清潔： 使用設施請保持共用設施清潔，以便他人使用。</li>
            <li>遵守營區指引： 遵從營區工作人員的指引和規定，維護營區秩序。</li>
            <li>禁止煩擾野生動物： 請不要騷擾或攪擾營區附近的野生動植物。</li>
            <li>緊急應變： 知悉營區緊急應變程序，確保安全。</li>
          </ol>
          <p class="guide-rules-end">以上規範旨在維護營區秩序和保護自然環境，希望所有露營者都能共同遵守。</p>
        </div>
      </div>
...
<style lang="scss" scoped>
  ...
  .guide-map {
    width: 100%;
    background: linear-gradient(to bottom , rgba(139,252,239,0.7), rgba(139,252,239,0)); 
  }
